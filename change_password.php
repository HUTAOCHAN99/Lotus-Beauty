        ...
        <form method="POST" action="">
            ...
            <div class="relative mb-4">
                <input type="password" id="confirm_password" name="confirm_password"
                    placeholder="Konfirmasi Kata Sandi Baru" class="w-full px-4 py-2 border rounded focus:outline-none"
                    required>
            ...
            <button type="submit" class="w-full bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Ganti Kata
                Sandi</button>
        </form>
    </div>
